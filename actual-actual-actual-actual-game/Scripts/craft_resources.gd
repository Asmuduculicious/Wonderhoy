...
func _on_pressed() -> void:
	...
	and wood >= global.wood):
		...
		if product == "level_1_weapon":
			...
			global.level_2_weapon
			global.level_2_weapon_avalaible += 1
		elif product == "level_3_weapon":
			global.level_3_weapon
			global.level_3_weapon_avalaible += 1
		elif product == "level_1_armor":
			global.level_1_armor
			global.level_1_armor_avalaible += 1
		elif product == "level_2_armor":
			global.level_2_armor
			global.level_2_armor_avalaible += 1
		elif product == "level_3_armor":
			global.level_3_armor
			global.level_3_armor_avalaible += 1
		elif product == "level_1_tank":
			global.level_1_tank
			global.level_1_tank_avalaible += 1
		elif product == "level_2_tank":
			global.level_2_tank
			global.level_2_tank_avalaible += 1
		elif product == "level_3_tank":
			global.level_3_tank
			global.level_3_tank_avalaible += 1
